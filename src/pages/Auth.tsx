...
const Auth = () => {
  ...
  return (
    <>
      ...
      <div className="absolute top-20 left-10 w-16 h-16 border-2 border-primary-glow/60 <div className="absolute top-20 left-10 w-16 h-16 border-2 border-primary-glow/60 bg-primary/25 rotate-45 animate-float shadow-cyber" /> animate-float shadow-cyber" />

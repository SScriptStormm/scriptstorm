...
const Auth = () => {
  ...
  return (
    <>
      ...
      <div className="absolute top-20 left-10 w-16 h-16 border-2 border-primary-glow/30 bg-primary-glow/15 rotate-45 animate-float shadow-cyber" />
      ...
      <div className="absolute bottom-40 left-20 w-10 h-10 border-2 border-primary-glow/35 bg-primary-glow/15 rotate-45 animate-float shadow-cyber" style={{ animationDelay: '4s' }} />
      <div className="absolute top-60 right-40 w-8 h-8 border border-primary-glow/20 rotate-90 animate-float shadow-cyber" style={{ animationDelay: '1s' }} />
      <div className="absolute bottom-60 right-10 w-14 h-14 border border-primary-glow/25 rotate-12 animate-float shadow-cyber" style={{ animationDelay: '3s' }} />

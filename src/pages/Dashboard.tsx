              ...
              {articles.length > 0 && <div className="flex flex-col gap-3">
                  ...
                  <div className="flex gap-1.5 overflow-x-auto pb-2 -mx-1 px-1">
                    <Button
                      ...
                      className={`font-mono text-xs whitespace-nowrap flex-shrink-0 transition-all duration-200 px-2 h-8 sm:h-7 lg:h-8 lg:px-3 ${
                        statusFilter === 'all' 
                          ...
                          >
                            ...
                            <td className={`py-4 text-right pr-3 border-r-2 ${isSelected ? 'border-primary-glow/60 rounded-r-lg' : 'border-white/[0.08]'}`}>
                              <div className="flex items-center gap-2 justify-end">
                                <Button size="icon" variant="ghost" className="h-8 w-8 -translate-x-[2px] text-primary-glow/70 hover:text-primary-glow border border-primary-glow/20 hover:border-primary-glow/50 hover:bg-primary-glow/10" onClick={(e) => { e.stopPropagation(); handleViewBrief(article); }} title="View Brief Details">

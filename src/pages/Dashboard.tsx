            ...
            <div className="flex flex-col gap-3 sm:gap-4">
              ...
              {articles.length > 0 && <div className="flex flex-col gap-3">
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <div className="relative hidden lg:block flex-shrink-0 w-48 pb-2">
                      ...
                      <input
                        ...
                        className="w-full pl-8 pr-7 py-1.5 bg-black/50 backdrop-blur-sm border border-white/[0.15] rounded-md text-white font-mono text-xs placeholder:text-white/30 focus:outline-none focus:border-primary-glow/50 focus:shadow-[0_0_10px_hsl(221_83%_53%/0.15)] transition-all duration-200 hover:border-white/[0.25]"
                      />
                      {searchQuery && (
                        <button

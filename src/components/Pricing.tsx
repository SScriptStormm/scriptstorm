          ...
          {packages.map((pkg) => (
            <Card key={pkg.id} className={`relative border-2 hover:scale-105 transition-all duration-300 h-full flex flex-col ${
              ...
              <CardContent className="space-y-6 pb-2 flex-1 flex flex-col">
                ...
                <div className={`${pkg.id === 'starter' && isAnnual ? 'space-y-10 md:space-y-14 lg:space-y-14' : pkg.id === 'starter' ? 'space-y-6 md:space-y-10 lg:space-y-10' : 'space-y-3 md:space-y-7 lg:space-y-7'} flex-1`}>

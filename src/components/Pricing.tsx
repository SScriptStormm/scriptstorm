...
const Pricing = () => {
  ...
  const packages = [{
    ...
    features: ['5 Foundational Blog Articles (1,500-2,000 words each): Deeply-researched, SEO-optimized content designed to attract organic traffic and establish your expertise.', '15 Ready-to-Post Social Media Captions: Engaging posts tailored for LinkedIn, X (Twitter), or Instagram to drive discussion and promote your new articles.', '5 Persuasive Product Descriptions: Compelling copy that highlights benefits and drives conversions for your key offerings.', '24-Hour Orchestrated Delivery: A relentless, daily content production cycle that keeps you constantly ahead of the competition.', "1 Dedicated Revision Round: We fine-tune your content to ensure it meets your expectations.", 'Plagiarism & AI Scan Guarantee: Every piece is guaranteed to be original and pass the latest AI detection benchmarks.', 'Standard Keyword Research: We target relevant keywords to ensure your content gets found.'],
  ...
  const enterprisePackages = [{
    ...
    color: '#8B5CF6',
    features: ['25 Foundational Blog Articles (2,000-3,000 words each): Deeply-researched, SEO-optimized content designed to attract organic traffic and establish your expertise.', '75 Strategic Social Media Posts: A multi-channel campaign to amplify your content, engage your entire market, and drive qualified leads at scale.', '25 High-Conversion Product/Service Pages: Persuasive, SEO-optimized copy to transform your key offerings into your top sales performers.', '24-Hour Orchestrated Delivery: A relentless, daily content production cycle that keeps you constantly ahead of the competition.', '2 Rounds of Priority Revisions: Refine content to perfection with our dedicated revision process.', 'Advanced Keyword & Competitor Annihilation: We don\'t just analyze competitors; we identify and exploit their weaknesses to steal their market share.', 'Plagiarism & AI Scan Guarantee: Enterprise-grade originality and quality assurance.', 'Efficient Support Portal: Streamlined communication for seamless project management.'],
    annualFeatures: ['25 Foundational Blog Articles (2,000-3,000 words each): Deeply-researched, SEO-optimized content designed to attract organic traffic and establish your expertise.', '75 Strategic Social Media Posts: A multi-channel campaign to amplify your content, engage your entire market, and drive qualified leads at scale.', '25 High-Conversion Product/Service Pages: Persuasive, SEO-optimized copy to transform your key offerings into your top sales performers.', '24-Hour Orchestrated Delivery: A relentless, daily content production cycle that keeps you constantly ahead of the competition.', '2 Rounds of Priority Revisions: Refine content to perfection with our dedicated revision process.', 'Advanced Keyword & Competitor Annihilation: We don\'t just analyze competitors; we identify and exploit their weaknesses to steal their market share.', 'Plagiarism & AI Scan Guarantee: Enterprise-grade originality and quality assurance.', 'Efficient Support Portal: Streamlined communication for seamless project management.'],

...
const Pricing = () => {
  ...
  const enterprisePackages = [{
    ...
    color: '#8B5CF6',
    features: ['25 SEO Blog Articles (2,000-3,000 words each): Deeply-researched, SEO-optimized content designed to attract organic traffic and establish your expertise.', '75 Social & Video Content: A multi-platform mix of posts for LinkedIn, X, and Instagram, plus YouTube video script outlines to drive traffic and build authority.', '25 Product/Service Descriptions: Compelling, conversion-optimized copy that highlights benefits and drives sales for your key offerings.', '24-Hour Orchestrated Delivery: A relentless, daily content production cycle that keeps you constantly ahead of the competition.', '2 Revision Rounds: Refine content to perfection with our dedicated revision process.', 'Advanced Keyword & Competitor Annihilation: We don\'t just analyze competitors; we identify and exploit their weaknesses to steal their market share.', 'Plagiarism & AI Scan Guarantee: Every piece is guaranteed original and passes the latest AI detection benchmarks.', 'Efficient Support Portal: Streamlined communication for seamless project management.'],

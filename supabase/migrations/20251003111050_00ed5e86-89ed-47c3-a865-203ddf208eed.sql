...
DROP POLICY IF EXISTS "contact_submissions_admin_function_select" ON public.contact_submissions;
DROP POLICY IF EXISTS "contact_submissions_admin_function_update" ON public.contact_submissions;
DROP POLICY IF EXISTS "contact_submissions_admin_insert" ON public.contact_submissions;
...
DROP POLICY IF EXISTS "contact_submissions_restrict_non_admins" ON public.contact_submissions;
DROP POLICY IF EXISTS "contact_submissions_submit_insert_only" ON public.contact_submissions;
